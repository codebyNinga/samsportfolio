    ...
    >
      ...
      <nav>
        ...
        <CustomLink href="/Contact" title="Contact" className='ml-4'/>
          ...
          <motion.a href="mailto:ninga254@gmail.com" target={"_blank"}
          whileHover={{y:-2}}
          whileTap={{scale :0.9}}
          className="w-6 mx-3"
          >
          ...
          <motion.a href="https://github.com/samgit36?tab=repositories" target={"_blank"}
          whileHover={{y:-2}}
          whileTap={{scale :0.9}}
          className="w-6 mx-3"
          >
          ...
          <motion.a href="https://www.linkedin.com/in/samuelninga/" target={"_blank"}
          whileHover={{y:-2}}
          whileTap={{scale :0.9}}
          className="w-6 mx-3"
          >
